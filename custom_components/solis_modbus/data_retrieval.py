...
# Register for RC Force Charge/Discharge keep-alive
FORCE_CHARGE_REGISTER = 43135
FORCE_NONE_VALUE = 0
# How often (seconds) to re-write the force charge/discharge register to prevent inverter timeout
...
class DataRetrieval:
    def __init__(self, hass: HomeAssistant, controller: ModbusController):
        ...
        self._force_active_value = FORCE_NONE_VALUE  # 0 = none, 1 = charge, 2 = discharge
    ...
    async def poll_controller(self, event=None):
        ...
        # Keep-alive for RC Force Charge/Discharge (register 43135)
        self._unsub_listeners.append(
